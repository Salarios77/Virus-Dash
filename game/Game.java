...
public class Game extends JPanel implements KeyListener, ActionListener, MouseListener
{
  ...
  public Game (GameFrame frame)
  {
    ...
    {
      difficultyName = "Easy";
      difficultyFactor = 2.75;
    }
    else if (frame.getGameInfo ().getDifficulty () == 2)
    {
      difficultyName = "Normal";
      difficultyFactor = 3.25;
    }
    else
    {
      difficultyName = "Hard";
      difficultyFactor = 3.75;
    }
  ...
  private void displayPane (int type)
  {
    ...
    if (type ==1) //pathogen msg
    {
      ...
      {
        info = "This is you (that green almost rod like thing with ribbons at the end), a Listeria bacteria. <br><br>This bacterium can cause fever, stiff necks, confusion, weakness vomiting and more, for days or even weeks. <br><br>Listeria reproduce in the mother cells, where they form until they are big enough, when the mother cell basically explodes and releases all the daughter cells. The daughters have the same genetic makeup as the mother cell.";
